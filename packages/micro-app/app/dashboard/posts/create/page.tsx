      ...
      <div className="space-y-12">
        <div className="border-b border-gray-900/10 pb-12">
          ...
          <p className="mt-1 text-sm leading-6 text-gray-600">
            This information will be displayed publicly as your post.
          </p>
        </div>

        <div className="border-b border-gray-900/10 pb-12">
          <h2 className="text-base font-semibold leading-7 text-gray-900">Post Meta</h2>
        ...
        <div className="border-b border-gray-900/10 pb-12">
          <h2 className="text-base font-semibold leading-7 text-gray-900">Post Content</h2>
          <p className="mt-1 text-sm leading-6 text-gray-600">
            Write a few sentences about your post. This will appear on the post page.
          </p>
